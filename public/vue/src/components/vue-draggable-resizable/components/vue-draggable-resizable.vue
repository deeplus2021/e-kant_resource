  ...
  methods: {
    ...
    calcDragLimits () {
      return {
        ...
        maxTop: this.maxT ? this.maxT : Math.floor((this.parentHeight - this.height - this.top) / this.grid[1]) * this.grid[1] + this.top,
    ...
    calcResizeLimits () {
      ...
      if (this.parent) {
        ...
        limits.maxTop = this.maxT ? this.maxT : top + Math.floor((height - minH) / gridY) * gridY
