        ...
        <template v-for="item in routes" v-if="!item.hidden">
            ...
            <router-link v-if="hasOneShowingChildren(item.children) && !item.children[0].children &&!item.alwaysShow"
                ...
                <el-menu-item :index="item.path+'/'+item.children[0].path"
                    ...
                    <img class="img-me"
                         :src="require(`../../../../assets/images/icon/${item.children[0].meta.icon}.png`)"
            ...
            <el-submenu v-else :index="item.name||item.path" :key="item.name">
                <template slot="title">
                    <img class="img-me" :src="require(`../../../../assets/images/icon/${item.meta.icon}.png`)"
                ...
                <template v-for="child in item.children" v-if="!child.hidden">
                    ...
                    <router-link v-else :to="item.path+'/'+child.path" :key="child.name">
                        <el-menu-item :index="item.path+'/'+child.path">
                            ...
                            <!-- <i class="el-icon-location" v-if="child.meta&&child.meta.icon"></i> -->
